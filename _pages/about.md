...
For the final part I'd love to talk about achievements aside of academics. I'm the core player / captain of the CUHKSZ / Harmonia College Soccer Team ⚽️, 2023 champion 🏆 of Shenzhen City, and also formed bands writing original songs covering Hardcore Punk, Blues Rock, R&B, Jazz-Hiphop, Post Rock, etc. As guitarist 🎸 keyboard 🎹 and lead singer 🎤, Led Zeppelin and Guns'n'Roses are among my favorites. Additionally, I attained ABRSM Grade 5 in Piano & Music Theory in Los Angeles by the age of 10, and also am the Top10 singers (1st place duet) of CUHKSZ 🏆. As team captain & mid, I also won the 2026 CUHKSZ League of Legends 🎮 Championship 🏆. Though extracurricular, I firmly believe these experiences link and help my academic works both subjectively & technically, also fostering open-mindedness and creativity in research.

****
# 🔥 News
- *2026.10*: &nbsp;🎤 Will present at the Single Cell Asia & Spatial Biology Asia Congress my MIRCID poster at the Nanyang Technological University.
- *2026.09* &nbsp;📄 Submitted 1-st Author Paper to _Advanced Science_, now available on [Arxiv](https://arxiv.org/abs/2609.21280).
...
- *2024.08*: &nbsp;🎤 Delivered Speech at the 2024 Opening Ceremony as the Student Representative of Harmonia College, awarded a scholarship of ¥10,000 RMB.
...
- *2023.10*: &nbsp;🏆 Champion of 2023 Shenzhen Soccer League, Runner-up of 2024 League, Core Player of school team.
- *2024.11*: &nbsp;🎸 Performance at [HOULIVE](https://weibo.com/6572337854/), Shenzhen's No.1 livehouse.
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Nov 2024</div><img src='images/MIRCID.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

**MIRCID: miRNA prediction for Cross-task Drug Mechanisms**

[The Chinese University of Hong Kong, Shenzhen](https://www.cuhk.edu.cn/en), Supervised by [Hsiend-Da Huang](https://med.cuhk.edu.cn/en/teacher/120)
- **miRNA Inference Model Development**: Developed HubmiRNet to map 977 L1000 genes to 1298/414 hub-miRNAs, outperforming Transformer, KAN, and DenseNet baselines with 87% Pearson correlation.
- **Mechanistic Pathway Analysis**: Constructed DL framework for cancer pathways and showed that miRNA features improved drug MoA & drug perturbation pathway classification.
- **Statistical/Ablational & Rescue Case Analyses**: For HubmiRNet outputs, performed ablation experiments, regularized CCA, CKA, ridge reconstruction trials. Also biologically analyzed rescue cases where gene-only predictions failed
</div>
</div>
...
- 📖 **English** : Five years of school in America (Native Speaker)
